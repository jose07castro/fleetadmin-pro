        ...
        try {
            ...
            <div class="dashboard-section animate-in" style="margin-bottom:var(--space-5); animation-delay: 0.1s;">
                ...
                <div class="quick-actions-scroll-container glass-card" style="display:flex; gap:var(--space-3); overflow-x:auto; padding:var(--space-4); margin:0 -4px; border-radius: 20px; scrollbar-width:none; -ms-overflow-style:none; -webkit-overflow-scrolling:touch;">
                    ...
                    <button class="q-btn" onclick="Router.navigate('vehicles')" style="background:linear-gradient(135deg, #8b5cf6, #6d28d9); color:white; border:none; padding:14px 20px; border-radius:16px; display:flex; align-items:center; gap:10px; font-weight:700; flex-shrink:0; box-shadow:0 8px 16px rgba(139,92,246,0.3); filter: drop-shadow(0 0 8px rgba(139, 92, 246, 0.4)); cursor:pointer; transition:all 0.2s;">
            ...
            <div class="stats-grid" id="dashboardStatsGrid" style="margin-bottom:var(--space-6);">
                ${(() => {
                    ...
                    const statCardsDict = {
                        ...
                        'card-earnings': '<div class="stat-card glass-card neon-glow-success animate-in" ' + dragAttr + ' data-id="card-earnings" style="cursor:pointer; animation-delay:0.4s;" onclick="Router.navigate(\'balances\')"><div class="stat-icon success" style="pointer-events:none;">💰</div><div style="pointer-events:none;"><div class="stat-value">' + I18n.t("unit_currency") + totalEarnings.toLocaleString() + '</div><div class="stat-label">' + I18n.t("dash_total_earnings") + ' →</div></div></div>',
                        'card-profit': '<div class="stat-card glass-card ' + (netProfit >= 0 ? "neon-glow-success" : "neon-glow-warning") + ' animate-in" ' + dragAttr + ' data-id="card-profit" style="cursor:pointer; animation-delay:0.5s;" onclick="Router.navigate(\'balances\')"><div class="stat-icon ' + (netProfit >= 0 ? "success" : "danger") + '" style="pointer-events:none;">📈</div><div style="pointer-events:none;"><div class="stat-value">' + I18n.t("unit_currency") + netProfit.toLocaleString() + '</div><div class="stat-label">' + I18n.t("dash_net_profit") + ' →</div></div></div>',
                        'card-expenses': '<div class="stat-card glass-card neon-glow-warning animate-in" ' + dragAttr + ' data-id="card-expenses" style="cursor:pointer; animation-delay:0.6s;" onclick="Router.navigate(\'balances\')"><div class="stat-icon warning" style="pointer-events:none;">💸</div><div style="pointer-events:none;"><div class="stat-value">' + I18n.t("unit_currency") + totalRepairCost.toLocaleString() + '</div><div class="stat-label">' + I18n.t("dash_expenses") + ' (' + I18n.t("maint_repairs") + ') →</div></div></div>',
