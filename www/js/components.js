            ...
            <div style="text-align:center; padding:var(--space-2);">
                ...
                <div style="margin-bottom:var(--space-4);">
                    ...
                    <div style="display:grid; grid-template-columns: repeat(2, 1fr); gap:10px;">
                        <button class="btn" onclick="navigator.clipboard.writeText('${alias}').then(() => { Components.showToast('✅ Alias copiado por $1.000. ¡Muchas gracias!', 'success'); })" style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.15); color:#ffffff !important; font-weight:700; display:flex; justify-content:center; align-items:center; border-radius:var(--radius-md); padding:12px; width:100%; font-size:14px; cursor:pointer;">$1.000</button>
                        <button class="btn" onclick="navigator.clipboard.writeText('${alias}').then(() => { Components.showToast('✅ Alias copiado por $3.000. ¡Muchas gracias!', 'success'); })" style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.15); color:#ffffff !important; font-weight:700; display:flex; justify-content:center; align-items:center; border-radius:var(--radius-md); padding:12px; width:100%; font-size:14px; cursor:pointer;">$3.000</button>
                        <button class="btn" onclick="navigator.clipboard.writeText('${alias}').then(() => { Components.showToast('✅ Alias copiado por $5.000. ¡Muchas gracias!', 'success'); })" style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.15); color:#ffffff !important; font-weight:700; display:flex; justify-content:center; align-items:center; border-radius:var(--radius-md); padding:12px; width:100%; font-size:14px; cursor:pointer;">$5.000</button>
                        <button class="btn" onclick="navigator.clipboard.writeText('${alias}').then(() => { Components.showToast('✅ Alias copiado. ¡Muchas gracias por tu aporte libre!', 'success'); })" style="background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.15); color:#ffffff !important; font-weight:700; display:flex; justify-content:center; align-items:center; border-radius:var(--radius-md); padding:12px; width:100%; font-size:14px; cursor:pointer;">Monto Libre</button>
                    </div>
                </div>
            </div>
        `;
