...
const CACHE_NAME = 'fleetadmin-pro-v170';
const ASSETS = [
    './',
    './index.html?v=170',
    './css/index.css?v=170',
    ...
    './js/auth.js?v=170',
    './js/alerts.js?v=170',
    './js/components.js?v=170',
    './js/router.js?v=170',
    './js/storage.js?v=170',
    './js/modules/login.js?v=170',
    './js/modules/dashboard.js?v=170',
    './js/modules/shifts.js?v=170',
    './js/modules/maintenance.js?v=170',
    './js/modules/vehicles.js?v=170',
    './js/modules/settings.js?v=170',
    './js/modules/community.js?v=170',
    './js/modules/sos.js?v=170',
    './js/modules/announcements.js?v=170',
    './js/whatsapp.js?v=170',
    './js/modules/gps.js?v=170',
    './js/fcm.js?v=170',
    './js/notifications.js?v=170',
    './js/pwa-install.js?v=170',
    './js/ui-settings.js?v=170',
    './js/modules/radar-v126.js?v=170',
    './js/gps-permissions.js?v=170',
    './js/app.js?v=170',
    './manifest.json?v=170',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=170',
    './assets/auto-conductor2.png?v=170'
];
