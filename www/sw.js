...
const CACHE_NAME = 'fleetadmin-pro-v168';
const ASSETS = [
    './',
    './index.html?v=168',
    './css/index.css?v=168',
    ...
    './js/auth.js?v=168',
    './js/alerts.js?v=168',
    './js/components.js?v=168',
    './js/router.js?v=168',
    './js/storage.js?v=168',
    './js/modules/login.js?v=168',
    './js/modules/dashboard.js?v=168',
    './js/modules/shifts.js?v=168',
    './js/modules/maintenance.js?v=168',
    './js/modules/vehicles.js?v=168',
    './js/modules/settings.js?v=168',
    './js/modules/community.js?v=168',
    './js/modules/sos.js?v=168',
    './js/modules/announcements.js?v=168',
    './js/whatsapp.js?v=168',
    './js/modules/gps.js?v=168',
    './js/fcm.js?v=168',
    './js/notifications.js?v=168',
    './js/pwa-install.js?v=168',
    './js/ui-settings.js?v=168',
    './js/modules/radar-v126.js?v=168',
    './js/gps-permissions.js?v=168',
    './js/app.js?v=168',
    './manifest.json?v=168',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=168',
    './assets/auto-conductor2.png?v=168'
];
