...
const CACHE_NAME = 'fleetadmin-pro-v174';
const ASSETS = [
    './',
    './index.html?v=174',
    './css/index.css?v=174',
    ...
    './js/auth.js?v=174',
    './js/alerts.js?v=174',
    './js/components.js?v=174',
    './js/router.js?v=174',
    './js/storage.js?v=174',
    './js/modules/login.js?v=174',
    './js/modules/dashboard.js?v=174',
    './js/modules/shifts.js?v=174',
    './js/modules/maintenance.js?v=174',
    './js/modules/vehicles.js?v=174',
    './js/modules/settings.js?v=174',
    './js/modules/community.js?v=174',
    './js/modules/sos.js?v=174',
    './js/modules/announcements.js?v=174',
    './js/whatsapp.js?v=174',
    './js/modules/gps.js?v=174',
    './js/fcm.js?v=174',
    './js/notifications.js?v=174',
    './js/pwa-install.js?v=174',
    './js/ui-settings.js?v=174',
    './js/modules/radar-v126.js?v=174',
    './js/gps-permissions.js?v=174',
    './js/app.js?v=174',
    './manifest.json?v=174',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=174',
    './assets/auto-conductor2.png?v=174'
];
