...
const CACHE_NAME = 'fleetadmin-pro-v152';
const ASSETS = [
    './',
    './index.html?v=152',
    './css/index.css?v=152',
    ...
    './js/i18n.js?v=152',
    './js/firebase-config.js?v=152',
    './js/db.js?v=152',
    './js/units.js?v=152',
    './js/auth.js?v=152',
    './js/alerts.js?v=152',
    './js/components.js?v=152',
    './js/router.js?v=152',
    './js/storage.js?v=152',
    './js/modules/login.js?v=152',
    './js/modules/dashboard.js?v=152',
    './js/modules/shifts.js?v=152',
    './js/modules/maintenance.js?v=152',
    './js/modules/vehicles.js?v=152',
    './js/modules/settings.js?v=152',
    './js/modules/community.js?v=152',
    './js/modules/sos.js?v=152',
    './js/modules/announcements.js?v=152',
    './js/whatsapp.js?v=152',
    './js/modules/gps.js?v=152',
    './js/fcm.js?v=152',
    './js/notifications.js?v=152',
    './js/pwa-install.js?v=152',
    './js/ui-settings.js?v=152',
    './js/modules/radar-v126.js?v=152',
    './js/gps-permissions.js?v=152',
    './js/app.js?v=152',
    './manifest.json?v=152',
    './assets/icon.svg',
    './assets/icon-192.png',
