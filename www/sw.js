...
const CACHE_NAME = 'fleetadmin-pro-v175';
const ASSETS = [
    './',
    './index.html?v=175',
    './css/index.css?v=175',
    ...
    './js/auth.js?v=175',
    './js/alerts.js?v=175',
    './js/components.js?v=175',
    './js/router.js?v=175',
    './js/storage.js?v=175',
    './js/modules/login.js?v=175',
    './js/modules/dashboard.js?v=175',
    './js/modules/shifts.js?v=175',
    './js/modules/maintenance.js?v=175',
    './js/modules/vehicles.js?v=175',
    './js/modules/settings.js?v=175',
    './js/modules/community.js?v=175',
    './js/modules/sos.js?v=175',
    './js/modules/announcements.js?v=175',
    './js/whatsapp.js?v=175',
    './js/modules/gps.js?v=175',
    './js/fcm.js?v=175',
    './js/notifications.js?v=175',
    './js/pwa-install.js?v=175',
    './js/ui-settings.js?v=175',
    './js/modules/radar-v126.js?v=175',
    './js/gps-permissions.js?v=175',
    './js/app.js?v=175',
    './manifest.json?v=175',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=175',
    './assets/auto-conductor2.png?v=175'
];
