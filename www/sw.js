...
const CACHE_NAME = 'fleetadmin-pro-v164';
const ASSETS = [
    './',
    './index.html?v=164',
    './css/index.css?v=164',
    ...
    './js/auth.js?v=164',
    './js/alerts.js?v=164',
    './js/components.js?v=164',
    './js/router.js?v=164',
    './js/storage.js?v=164',
    './js/modules/login.js?v=164',
    './js/modules/dashboard.js?v=164',
    './js/modules/shifts.js?v=164',
    './js/modules/maintenance.js?v=164',
    './js/modules/vehicles.js?v=164',
    './js/modules/settings.js?v=164',
    './js/modules/community.js?v=164',
    './js/modules/sos.js?v=164',
    './js/modules/announcements.js?v=164',
    './js/whatsapp.js?v=164',
    './js/modules/gps.js?v=164',
    './js/fcm.js?v=164',
    './js/notifications.js?v=164',
    './js/pwa-install.js?v=164',
    './js/ui-settings.js?v=164',
    './js/modules/radar-v126.js?v=164',
    './js/gps-permissions.js?v=164',
    './js/app.js?v=164',
    './manifest.json?v=164',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=164',
    './assets/auto-conductor2.png?v=164'
];
