...
const CACHE_NAME = 'fleetadmin-pro-v162';
const ASSETS = [
    './',
    './index.html?v=162',
    './css/index.css?v=162',
    ...
    './js/auth.js?v=162',
    './js/alerts.js?v=162',
    './js/components.js?v=162',
    './js/router.js?v=162',
    './js/storage.js?v=162',
    './js/modules/login.js?v=162',
    './js/modules/dashboard.js?v=162',
    './js/modules/shifts.js?v=162',
    './js/modules/maintenance.js?v=162',
    './js/modules/vehicles.js?v=162',
    './js/modules/settings.js?v=162',
    './js/modules/community.js?v=162',
    './js/modules/sos.js?v=162',
    './js/modules/announcements.js?v=162',
    './js/whatsapp.js?v=162',
    './js/modules/gps.js?v=162',
    './js/fcm.js?v=162',
    './js/notifications.js?v=162',
    './js/pwa-install.js?v=162',
    './js/ui-settings.js?v=162',
    './js/modules/radar-v126.js?v=162',
    './js/gps-permissions.js?v=162',
    './js/app.js?v=162',
    './manifest.json?v=162',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=162',
    './assets/auto-conductor2.png?v=162'
];
