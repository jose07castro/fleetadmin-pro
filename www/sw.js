...
const CACHE_NAME = 'fleetadmin-pro-v171';
const ASSETS = [
    './',
    './index.html?v=171',
    './css/index.css?v=171',
    ...
    './js/auth.js?v=171',
    './js/alerts.js?v=171',
    './js/components.js?v=171',
    './js/router.js?v=171',
    './js/storage.js?v=171',
    './js/modules/login.js?v=171',
    './js/modules/dashboard.js?v=171',
    './js/modules/shifts.js?v=171',
    './js/modules/maintenance.js?v=171',
    './js/modules/vehicles.js?v=171',
    './js/modules/settings.js?v=171',
    './js/modules/community.js?v=171',
    './js/modules/sos.js?v=171',
    './js/modules/announcements.js?v=171',
    './js/whatsapp.js?v=171',
    './js/modules/gps.js?v=171',
    './js/fcm.js?v=171',
    './js/notifications.js?v=171',
    './js/pwa-install.js?v=171',
    './js/ui-settings.js?v=171',
    './js/modules/radar-v126.js?v=171',
    './js/gps-permissions.js?v=171',
    './js/app.js?v=171',
    './manifest.json?v=171',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=171',
    './assets/auto-conductor2.png?v=171'
];
