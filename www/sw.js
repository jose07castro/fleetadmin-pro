...
const CACHE_NAME = 'fleetadmin-pro-v179';
const ASSETS = [
    './',
    './index.html?v=179',
    './css/index.css?v=179',
    ...
    './js/auth.js?v=179',
    './js/alerts.js?v=179',
    './js/components.js?v=179',
    './js/router.js?v=179',
    './js/storage.js?v=179',
    './js/modules/login.js?v=179',
    './js/modules/dashboard.js?v=179',
    './js/modules/shifts.js?v=179',
    './js/modules/maintenance.js?v=179',
    './js/modules/vehicles.js?v=179',
    './js/modules/settings.js?v=179',
    './js/modules/community.js?v=179',
    './js/modules/sos.js?v=179',
    './js/modules/announcements.js?v=179',
    './js/whatsapp.js?v=179',
    './js/modules/gps.js?v=179',
    './js/fcm.js?v=179',
    './js/notifications.js?v=179',
    './js/pwa-install.js?v=179',
    './js/ui-settings.js?v=179',
    './js/modules/radar-v126.js?v=179',
    './js/gps-permissions.js?v=179',
    './js/app.js?v=179',
    './manifest.json?v=179',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=179',
    './assets/auto-conductor2.png?v=179'
];
