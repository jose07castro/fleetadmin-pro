...
const CACHE_NAME = 'fleetadmin-pro-v169';
const ASSETS = [
    './',
    './index.html?v=169',
    './css/index.css?v=169',
    ...
    './js/auth.js?v=169',
    './js/alerts.js?v=169',
    './js/components.js?v=169',
    './js/router.js?v=169',
    './js/storage.js?v=169',
    './js/modules/login.js?v=169',
    './js/modules/dashboard.js?v=169',
    './js/modules/shifts.js?v=169',
    './js/modules/maintenance.js?v=169',
    './js/modules/vehicles.js?v=169',
    './js/modules/settings.js?v=169',
    './js/modules/community.js?v=169',
    './js/modules/sos.js?v=169',
    './js/modules/announcements.js?v=169',
    './js/whatsapp.js?v=169',
    './js/modules/gps.js?v=169',
    './js/fcm.js?v=169',
    './js/notifications.js?v=169',
    './js/pwa-install.js?v=169',
    './js/ui-settings.js?v=169',
    './js/modules/radar-v126.js?v=169',
    './js/gps-permissions.js?v=169',
    './js/app.js?v=169',
    './manifest.json?v=169',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=169',
    './assets/auto-conductor2.png?v=169'
];
