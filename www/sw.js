...
const CACHE_NAME = 'fleetadmin-pro-v176';
const ASSETS = [
    './',
    './index.html?v=176',
    './css/index.css?v=176',
    ...
    './js/auth.js?v=176',
    './js/alerts.js?v=176',
    './js/components.js?v=176',
    './js/router.js?v=176',
    './js/storage.js?v=176',
    './js/modules/login.js?v=176',
    './js/modules/dashboard.js?v=176',
    './js/modules/shifts.js?v=176',
    './js/modules/maintenance.js?v=176',
    './js/modules/vehicles.js?v=176',
    './js/modules/settings.js?v=176',
    './js/modules/community.js?v=176',
    './js/modules/sos.js?v=176',
    './js/modules/announcements.js?v=176',
    './js/whatsapp.js?v=176',
    './js/modules/gps.js?v=176',
    './js/fcm.js?v=176',
    './js/notifications.js?v=176',
    './js/pwa-install.js?v=176',
    './js/ui-settings.js?v=176',
    './js/modules/radar-v126.js?v=176',
    './js/gps-permissions.js?v=176',
    './js/app.js?v=176',
    './manifest.json?v=176',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=176',
    './assets/auto-conductor2.png?v=176'
];
