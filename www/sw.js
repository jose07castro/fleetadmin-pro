...
const CACHE_NAME = 'fleetadmin-pro-v163';
const ASSETS = [
    './',
    './index.html?v=163',
    './css/index.css?v=163',
    ...
    './js/auth.js?v=163',
    './js/alerts.js?v=163',
    './js/components.js?v=163',
    './js/router.js?v=163',
    './js/storage.js?v=163',
    './js/modules/login.js?v=163',
    './js/modules/dashboard.js?v=163',
    './js/modules/shifts.js?v=163',
    './js/modules/maintenance.js?v=163',
    './js/modules/vehicles.js?v=163',
    './js/modules/settings.js?v=163',
    './js/modules/community.js?v=163',
    './js/modules/sos.js?v=163',
    './js/modules/announcements.js?v=163',
    './js/whatsapp.js?v=163',
    './js/modules/gps.js?v=163',
    './js/fcm.js?v=163',
    './js/notifications.js?v=163',
    './js/pwa-install.js?v=163',
    './js/ui-settings.js?v=163',
    './js/modules/radar-v126.js?v=163',
    './js/gps-permissions.js?v=163',
    './js/app.js?v=163',
    './manifest.json?v=163',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=163',
    './assets/auto-conductor2.png?v=163'
];
