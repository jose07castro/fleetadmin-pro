...
const CACHE_NAME = 'fleetadmin-pro-v165';
const ASSETS = [
    './',
    './index.html?v=165',
    './css/index.css?v=165',
    ...
    './js/auth.js?v=165',
    './js/alerts.js?v=165',
    './js/components.js?v=165',
    './js/router.js?v=165',
    './js/storage.js?v=165',
    './js/modules/login.js?v=165',
    './js/modules/dashboard.js?v=165',
    './js/modules/shifts.js?v=165',
    './js/modules/maintenance.js?v=165',
    './js/modules/vehicles.js?v=165',
    './js/modules/settings.js?v=165',
    './js/modules/community.js?v=165',
    './js/modules/sos.js?v=165',
    './js/modules/announcements.js?v=165',
    './js/whatsapp.js?v=165',
    './js/modules/gps.js?v=165',
    './js/fcm.js?v=165',
    './js/notifications.js?v=165',
    './js/pwa-install.js?v=165',
    './js/ui-settings.js?v=165',
    './js/modules/radar-v126.js?v=165',
    './js/gps-permissions.js?v=165',
    './js/app.js?v=165',
    './manifest.json?v=165',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=165',
    './assets/auto-conductor2.png?v=165'
];
