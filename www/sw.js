...
const CACHE_NAME = 'fleetadmin-pro-v180';
const ASSETS = [
    './',
    './index.html?v=180',
    './css/index.css?v=180',
    ...
    './js/auth.js?v=180',
    './js/alerts.js?v=180',
    './js/components.js?v=180',
    './js/router.js?v=180',
    './js/storage.js?v=180',
    './js/modules/login.js?v=180',
    './js/modules/dashboard.js?v=180',
    './js/modules/shifts.js?v=180',
    './js/modules/maintenance.js?v=180',
    './js/modules/vehicles.js?v=180',
    './js/modules/settings.js?v=180',
    './js/modules/community.js?v=180',
    './js/modules/sos.js?v=180',
    './js/modules/announcements.js?v=180',
    './js/whatsapp.js?v=180',
    './js/modules/gps.js?v=180',
    './js/fcm.js?v=180',
    './js/notifications.js?v=180',
    './js/pwa-install.js?v=180',
    './js/ui-settings.js?v=180',
    './js/modules/radar-v126.js?v=180',
    './js/gps-permissions.js?v=180',
    './js/app.js?v=180',
    './manifest.json?v=180',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=180',
    './assets/auto-conductor2.png?v=180'
];
