...
const CACHE_NAME = 'fleetadmin-v78';
const ASSETS = [
    './',
    './index.html?v=78',
    './css/index.css?v=78',
    ...
    './js/router.js?v=78',
    './js/modules/login.js?v=78',
    './js/modules/dashboard.js?v=78',
    './js/modules/shifts.js?v=78',
    './js/modules/maintenance.js?v=78',
    './js/modules/vehicles.js?v=78',
    './js/modules/settings.js?v=78',
    './js/modules/community.js?v=78',
    './js/modules/sos.js?v=78',
    './js/modules/announcements.js?v=78',
    './js/whatsapp.js?v=78',
    './js/storage.js?v=78',
    './js/modules/gps.js?v=78',
    './js/fcm.js?v=78',
    './js/notifications.js?v=78',
    './js/pwa-install.js?v=78',
    './js/app.js?v=78',
    './manifest.json?v=78',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=78')
