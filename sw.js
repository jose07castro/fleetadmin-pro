...
const CACHE_NAME = 'fleetadmin-pro-v91';
const ASSETS = [
    './',
    './index.html?v=91',
    './css/index.css?v=91',
    ...
    './js/i18n.js?v=91',
    './js/firebase-config.js?v=91',
    './js/db.js?v=91',
    './js/units.js?v=91',
    './js/auth.js?v=91',
    './js/alerts.js?v=91',
    './js/components.js?v=91',
    './js/router.js?v=91',
    './js/storage.js?v=91',
    './js/modules/login.js?v=91',
    './js/modules/dashboard.js?v=91',
    './js/modules/shifts.js?v=91',
    './js/modules/maintenance.js?v=91',
    './js/modules/vehicles.js?v=91',
    './js/modules/settings.js?v=91',
    './js/modules/community.js?v=91',
    './js/modules/sos.js?v=91',
    './js/modules/announcements.js?v=91',
    './js/whatsapp.js?v=91',
    './js/modules/gps.js?v=91',
    './js/fcm.js?v=91',
    './js/notifications.js?v=91',
    './js/pwa-install.js?v=91',
    './js/app.js?v=91',
    './manifest.json?v=91',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=91')
