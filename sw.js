...
const CACHE_NAME = 'fleetadmin-v74';
const ASSETS = [
    './',
    './index.html?v=74',
    './css/index.css?v=74',
    ...
    './js/i18n.js?v=74',
    './js/firebase-config.js?v=74',
    './js/db.js?v=74',
    './js/units.js?v=74',
    './js/auth.js?v=74',
    './js/alerts.js?v=74',
    './js/components.js?v=74',
    './js/router.js?v=74',
    './js/modules/login.js?v=74',
    './js/modules/dashboard.js?v=74',
    './js/modules/shifts.js?v=74',
    './js/modules/maintenance.js?v=74',
    './js/modules/vehicles.js?v=74',
    './js/modules/settings.js?v=74',
    './js/modules/community.js?v=74',
    './js/modules/sos.js?v=74',
    './js/modules/announcements.js?v=74',
    './js/whatsapp.js?v=74',
    './js/storage.js?v=74',
    './js/modules/gps.js?v=74',
    './js/fcm.js?v=74',
    './js/notifications.js?v=74',
    './js/pwa-install.js?v=74',
    './js/app.js?v=74',
    './manifest.json?v=74',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=74')
