...
const CACHE_NAME = 'fleetadmin-v71';
const ASSETS = [
    './',
    './index.html?v=71',
    './css/index.css?v=71',
    ...
    './js/i18n.js?v=71',
    './js/firebase-config.js?v=71',
    './js/db.js?v=71',
    './js/units.js?v=71',
    './js/auth.js?v=71',
    './js/alerts.js?v=71',
    './js/components.js?v=71',
    './js/router.js?v=71',
    './js/modules/login.js?v=71',
    './js/modules/dashboard.js?v=71',
    './js/modules/shifts.js?v=71',
    './js/modules/maintenance.js?v=71',
    './js/modules/vehicles.js?v=71',
    './js/modules/settings.js?v=71',
    './js/modules/community.js?v=71',
    './js/modules/sos.js?v=71',
    './js/modules/announcements.js?v=71',
    './js/whatsapp.js?v=71',
    './js/storage.js?v=71',
    './js/modules/gps.js?v=71',
    './js/fcm.js?v=71',
    './js/notifications.js?v=71',
    './js/pwa-install.js?v=71',
    './js/app.js?v=71',
    './manifest.json?v=71',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=71')
