...
const CACHE_NAME = 'fleetadmin-v81';
const ASSETS = [
    './',
    './index.html?v=81',
    './css/index.css?v=81',
    ...
    './js/router.js?v=81',
    './js/modules/login.js?v=81',
    './js/modules/dashboard.js?v=81',
    './js/modules/shifts.js?v=81',
    './js/modules/maintenance.js?v=81',
    './js/modules/vehicles.js?v=81',
    './js/modules/settings.js?v=81',
    './js/modules/community.js?v=81',
    './js/modules/sos.js?v=81',
    './js/modules/announcements.js?v=81',
    './js/whatsapp.js?v=81',
    './js/storage.js?v=81',
    './js/modules/gps.js?v=81',
    './js/fcm.js?v=81',
    './js/notifications.js?v=81',
    './js/pwa-install.js?v=81',
    './js/app.js?v=81',
    './manifest.json?v=81',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=81')
