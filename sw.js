...
const CACHE_NAME = 'fleetadmin-v72';
const ASSETS = [
    './',
    './index.html?v=72',
    './css/index.css?v=72',
    ...
    './js/i18n.js?v=72',
    './js/firebase-config.js?v=72',
    './js/db.js?v=72',
    './js/units.js?v=72',
    './js/auth.js?v=72',
    './js/alerts.js?v=72',
    './js/components.js?v=72',
    './js/router.js?v=72',
    './js/modules/login.js?v=72',
    './js/modules/dashboard.js?v=72',
    './js/modules/shifts.js?v=72',
    './js/modules/maintenance.js?v=72',
    './js/modules/vehicles.js?v=72',
    './js/modules/settings.js?v=72',
    './js/modules/community.js?v=72',
    './js/modules/sos.js?v=72',
    './js/modules/announcements.js?v=72',
    './js/whatsapp.js?v=72',
    './js/storage.js?v=72',
    './js/modules/gps.js?v=72',
    './js/fcm.js?v=72',
    './js/notifications.js?v=72',
    './js/pwa-install.js?v=72',
    './js/app.js?v=72',
    './manifest.json?v=72',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=72')
