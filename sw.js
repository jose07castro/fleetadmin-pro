...
const CACHE_NAME = 'fleetadmin-v69';
const ASSETS = [
    './',
    './index.html?v=69',
    './css/index.css?v=69',
    ...
    './js/i18n.js?v=69',
    './js/firebase-config.js?v=69',
    './js/db.js?v=69',
    './js/units.js?v=69',
    './js/auth.js?v=69',
    './js/alerts.js?v=69',
    './js/components.js?v=69',
    './js/router.js?v=69',
    './js/modules/login.js?v=69',
    './js/modules/dashboard.js?v=69',
    './js/modules/shifts.js?v=69',
    './js/modules/maintenance.js?v=69',
    './js/modules/vehicles.js?v=69',
    './js/modules/settings.js?v=69',
    './js/modules/community.js?v=69',
    './js/modules/sos.js?v=69',
    './js/modules/announcements.js?v=69',
    './js/whatsapp.js?v=69',
    './js/storage.js?v=69',
    './js/modules/gps.js?v=69',
    './js/fcm.js?v=69',
    './js/notifications.js?v=69',
    './js/pwa-install.js?v=69',
    './js/app.js?v=69',
    './manifest.json?v=69',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=69')
