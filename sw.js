...
const CACHE_NAME = 'fleetadmin-pro-v173';
const ASSETS = [
    './',
    './index.html?v=173',
    './css/index.css?v=173',
    ...
    './js/auth.js?v=173',
    './js/alerts.js?v=173',
    './js/components.js?v=173',
    './js/router.js?v=173',
    './js/storage.js?v=173',
    './js/modules/login.js?v=173',
    './js/modules/dashboard.js?v=173',
    './js/modules/shifts.js?v=173',
    './js/modules/maintenance.js?v=173',
    './js/modules/vehicles.js?v=173',
    './js/modules/settings.js?v=173',
    './js/modules/community.js?v=173',
    './js/modules/sos.js?v=173',
    './js/modules/announcements.js?v=173',
    './js/whatsapp.js?v=173',
    './js/modules/gps.js?v=173',
    './js/fcm.js?v=173',
    './js/notifications.js?v=173',
    './js/pwa-install.js?v=173',
    './js/ui-settings.js?v=173',
    './js/modules/radar-v126.js?v=173',
    './js/gps-permissions.js?v=173',
    './js/app.js?v=173',
    './manifest.json?v=173',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=173',
    './assets/auto-conductor2.png?v=173'
];
