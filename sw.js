...
const CACHE_NAME = 'fleetadmin-pro-v85';
const ASSETS = [
    './',
    './index.html?v=85',
    './css/index.css?v=85',
    ...
    './js/auth.js?v=85',
    './js/alerts.js?v=85',
    './js/components.js?v=85',
    './js/router.js?v=85',
    './js/modules/login.js?v=85',
    './js/modules/dashboard.js?v=85',
    './js/modules/shifts.js?v=85',
    './js/modules/maintenance.js?v=85',
    './js/modules/vehicles.js?v=85',
    './js/modules/settings.js?v=85',
    './js/modules/community.js?v=85',
    './js/modules/sos.js?v=85',
    './js/modules/announcements.js?v=85',
    './js/whatsapp.js?v=85',
    './js/storage.js?v=85',
    './js/modules/gps.js?v=85',
    './js/fcm.js?v=85',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=85')
