...
const CACHE_NAME = 'fleetadmin-v77';
const ASSETS = [
    './',
    './index.html?v=77',
    './css/index.css?v=77',
    ...
    './js/i18n.js?v=77',
    './js/firebase-config.js?v=77',
    './js/db.js?v=77',
    './js/units.js?v=77',
    './js/auth.js?v=77',
    './js/alerts.js?v=77',
    './js/components.js?v=77',
    './js/router.js?v=77',
    './js/modules/login.js?v=77',
    './js/modules/dashboard.js?v=77',
    './js/modules/shifts.js?v=77',
    './js/modules/maintenance.js?v=77',
    './js/modules/vehicles.js?v=77',
    './js/modules/settings.js?v=77',
    './js/modules/community.js?v=77',
    './js/modules/sos.js?v=77',
    './js/modules/announcements.js?v=77',
    './js/whatsapp.js?v=77',
    './js/storage.js?v=77',
    './js/modules/gps.js?v=77',
    './js/fcm.js?v=77',
    './js/notifications.js?v=77',
    './js/pwa-install.js?v=77',
    './js/app.js?v=77',
    './manifest.json?v=77',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=77')
