...
const CACHE_NAME = 'fleetadmin-v80';
const ASSETS = [
    './',
    './index.html?v=80',
    './css/index.css?v=80',
    ...
    './js/router.js?v=80',
    './js/modules/login.js?v=80',
    './js/modules/dashboard.js?v=80',
    './js/modules/shifts.js?v=80',
    './js/modules/maintenance.js?v=80',
    './js/modules/vehicles.js?v=80',
    './js/modules/settings.js?v=80',
    './js/modules/community.js?v=80',
    './js/modules/sos.js?v=80',
    './js/modules/announcements.js?v=80',
    './js/whatsapp.js?v=80',
    './js/storage.js?v=80',
    './js/modules/gps.js?v=80',
    './js/fcm.js?v=80',
    './js/notifications.js?v=80',
    './js/pwa-install.js?v=80',
    './js/app.js?v=80',
    './manifest.json?v=80',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=80')
