...
const CACHE_NAME = 'fleetadmin-pro-v87';
const ASSETS = [
    './',
    './index.html?v=87',
    './css/index.css?v=87',
    ...
    './js/i18n.js?v=87',
    './js/firebase-config.js?v=87',
    './js/db.js?v=87',
    './js/units.js?v=87',
    './js/auth.js?v=87',
    './js/alerts.js?v=87',
    './js/components.js?v=87',
    './js/router.js?v=87',
    './js/modules/login.js?v=87',
    './js/modules/dashboard.js?v=87',
    './js/modules/shifts.js?v=87',
    './js/modules/maintenance.js?v=87',
    './js/modules/vehicles.js?v=87',
    './js/modules/settings.js?v=87',
    './js/modules/community.js?v=87',
    './js/modules/sos.js?v=87',
    './js/modules/announcements.js?v=87',
    './js/whatsapp.js?v=87',
    './js/storage.js?v=87',
    './js/modules/gps.js?v=87',
    './js/fcm.js?v=87',
    './js/notifications.js?v=87',
    './js/pwa-install.js?v=87',
    './js/app.js?v=87',
    './manifest.json?v=87',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=87')
