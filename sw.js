...
const CACHE_NAME = 'fleetadmin-v67';
const ASSETS = [
    './',
    './index.html?v=67',
    './css/index.css?v=67',
    ...
    './js/i18n.js?v=67',
    './js/firebase-config.js?v=67',
    './js/db.js?v=67',
    './js/units.js?v=67',
    './js/auth.js?v=67',
    './js/alerts.js?v=67',
    './js/components.js?v=67',
    './js/router.js?v=67',
    './js/modules/login.js?v=67',
    './js/modules/dashboard.js?v=67',
    './js/modules/shifts.js?v=67',
    './js/modules/maintenance.js?v=67',
    './js/modules/vehicles.js?v=67',
    './js/modules/settings.js?v=67',
    './js/modules/community.js?v=67',
    './js/modules/sos.js?v=67',
    './js/modules/announcements.js?v=67',
    './js/whatsapp.js?v=67',
    './js/storage.js?v=67',
    './js/modules/gps.js?v=67',
    './js/fcm.js?v=67',
    './js/notifications.js?v=67',
    './js/pwa-install.js?v=67',
    './js/app.js?v=67',
    './manifest.json?v=67',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=67')
