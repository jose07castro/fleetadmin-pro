...
const CACHE_NAME = 'fleetadmin-v75';
const ASSETS = [
    './',
    './index.html?v=75',
    './css/index.css?v=75',
    ...
    './js/i18n.js?v=75',
    './js/firebase-config.js?v=75',
    './js/db.js?v=75',
    './js/units.js?v=75',
    './js/auth.js?v=75',
    './js/alerts.js?v=75',
    './js/components.js?v=75',
    './js/router.js?v=75',
    './js/modules/login.js?v=75',
    './js/modules/dashboard.js?v=75',
    './js/modules/shifts.js?v=75',
    './js/modules/maintenance.js?v=75',
    './js/modules/vehicles.js?v=75',
    './js/modules/settings.js?v=75',
    './js/modules/community.js?v=75',
    './js/modules/sos.js?v=75',
    './js/modules/announcements.js?v=75',
    './js/whatsapp.js?v=75',
    './js/storage.js?v=75',
    './js/modules/gps.js?v=75',
    './js/fcm.js?v=75',
    './js/notifications.js?v=75',
    './js/pwa-install.js?v=75',
    './js/app.js?v=75',
    './manifest.json?v=75',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=75')
