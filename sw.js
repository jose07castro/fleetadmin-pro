...
const CACHE_NAME = 'fleetadmin-v73';
const ASSETS = [
    './',
    './index.html?v=73',
    './css/index.css?v=73',
    ...
    './js/i18n.js?v=73',
    './js/firebase-config.js?v=73',
    './js/db.js?v=73',
    './js/units.js?v=73',
    './js/auth.js?v=73',
    './js/alerts.js?v=73',
    './js/components.js?v=73',
    './js/router.js?v=73',
    './js/modules/login.js?v=73',
    './js/modules/dashboard.js?v=73',
    './js/modules/shifts.js?v=73',
    './js/modules/maintenance.js?v=73',
    './js/modules/vehicles.js?v=73',
    './js/modules/settings.js?v=73',
    './js/modules/community.js?v=73',
    './js/modules/sos.js?v=73',
    './js/modules/announcements.js?v=73',
    './js/whatsapp.js?v=73',
    './js/storage.js?v=73',
    './js/modules/gps.js?v=73',
    './js/fcm.js?v=73',
    './js/notifications.js?v=73',
    './js/pwa-install.js?v=73',
    './js/app.js?v=73',
    './manifest.json?v=73',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=73')
