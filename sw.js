...
const CACHE_NAME = 'fleetadmin-pro-v161';
const ASSETS = [
    './',
    './index.html?v=161',
    './css/index.css?v=161',
    ...
    './js/auth.js?v=161',
    './js/alerts.js?v=161',
    './js/components.js?v=161',
    './js/router.js?v=161',
    './js/storage.js?v=161',
    './js/modules/login.js?v=161',
    './js/modules/dashboard.js?v=161',
    './js/modules/shifts.js?v=161',
    './js/modules/maintenance.js?v=161',
    './js/modules/vehicles.js?v=161',
    './js/modules/settings.js?v=161',
    './js/modules/community.js?v=161',
    './js/modules/sos.js?v=161',
    './js/modules/announcements.js?v=161',
    './js/whatsapp.js?v=161',
    './js/modules/gps.js?v=161',
    './js/fcm.js?v=161',
    './js/notifications.js?v=161',
    './js/pwa-install.js?v=161',
    './js/ui-settings.js?v=161',
    './js/modules/radar-v126.js?v=161',
    './js/gps-permissions.js?v=161',
    './js/app.js?v=161',
    './manifest.json?v=161',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=161',
    './assets/auto-conductor2.png?v=161'
];
