...
const CACHE_NAME = 'fleetadmin-pro-v145';
const ASSETS = [
    './',
    './index.html?v=145',
    './css/index.css?v=145',
    ...
    './js/i18n.js?v=145',
    './js/firebase-config.js?v=145',
    './js/db.js?v=145',
    './js/units.js?v=145',
    './js/auth.js?v=145',
    './js/alerts.js?v=145',
    './js/components.js?v=145',
    './js/router.js?v=145',
    './js/storage.js?v=145',
    './js/modules/login.js?v=145',
    './js/modules/dashboard.js?v=145',
    './js/modules/shifts.js?v=145',
    './js/modules/maintenance.js?v=145',
    './js/modules/vehicles.js?v=145',
    './js/modules/settings.js?v=145',
    './js/modules/community.js?v=145',
    './js/modules/sos.js?v=145',
    './js/modules/announcements.js?v=145',
    './js/whatsapp.js?v=145',
    './js/modules/gps.js?v=145',
    './js/fcm.js?v=145',
    './js/notifications.js?v=145',
    './js/pwa-install.js?v=145',
    './js/ui-settings.js?v=145',
    './js/modules/radar-v126.js?v=145',
    './js/gps-permissions.js?v=145',
    './js/app.js?v=145',
    './manifest.json?v=145',
    './assets/icon.svg',
    './assets/icon-192.png',
