...
const CACHE_NAME = 'fleetadmin-pro-v82';
const ASSETS = [
    './',
    './index.html?v=82',
    './css/index.css?v=82',
    ...
    './js/i18n.js?v=82',
    './js/firebase-config.js?v=82',
    './js/db.js?v=82',
    './js/units.js?v=82',
    './js/auth.js?v=82',
    './js/alerts.js?v=82',
    './js/components.js?v=82',
    './js/router.js?v=82',
    './js/modules/login.js?v=82',
    './js/modules/dashboard.js?v=82',
    './js/modules/shifts.js?v=82',
    './js/modules/maintenance.js?v=82',
    './js/modules/vehicles.js?v=82',
    './js/modules/settings.js?v=82',
    './js/modules/community.js?v=82',
    './js/modules/sos.js?v=82',
    './js/modules/announcements.js?v=82',
    './js/whatsapp.js?v=82',
    './js/storage.js?v=82',
    './js/modules/gps.js?v=82',
    './js/fcm.js?v=82',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=82')
