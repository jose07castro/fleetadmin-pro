...
const CACHE_NAME = 'fleetadmin-pro-v166';
const ASSETS = [
    './',
    './index.html?v=166',
    './css/index.css?v=166',
    ...
    './js/auth.js?v=166',
    './js/alerts.js?v=166',
    './js/components.js?v=166',
    './js/router.js?v=166',
    './js/storage.js?v=166',
    './js/modules/login.js?v=166',
    './js/modules/dashboard.js?v=166',
    './js/modules/shifts.js?v=166',
    './js/modules/maintenance.js?v=166',
    './js/modules/vehicles.js?v=166',
    './js/modules/settings.js?v=166',
    './js/modules/community.js?v=166',
    './js/modules/sos.js?v=166',
    './js/modules/announcements.js?v=166',
    './js/whatsapp.js?v=166',
    './js/modules/gps.js?v=166',
    './js/fcm.js?v=166',
    './js/notifications.js?v=166',
    './js/pwa-install.js?v=166',
    './js/ui-settings.js?v=166',
    './js/modules/radar-v126.js?v=166',
    './js/gps-permissions.js?v=166',
    './js/app.js?v=166',
    './manifest.json?v=166',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=166',
    './assets/auto-conductor2.png?v=166'
];
