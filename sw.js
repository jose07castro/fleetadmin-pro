...
const CACHE_NAME = 'fleetadmin-pro-v172';
const ASSETS = [
    './',
    './index.html?v=172',
    './css/index.css?v=172',
    ...
    './js/auth.js?v=172',
    './js/alerts.js?v=172',
    './js/components.js?v=172',
    './js/router.js?v=172',
    './js/storage.js?v=172',
    './js/modules/login.js?v=172',
    './js/modules/dashboard.js?v=172',
    './js/modules/shifts.js?v=172',
    './js/modules/maintenance.js?v=172',
    './js/modules/vehicles.js?v=172',
    './js/modules/settings.js?v=172',
    './js/modules/community.js?v=172',
    './js/modules/sos.js?v=172',
    './js/modules/announcements.js?v=172',
    './js/whatsapp.js?v=172',
    './js/modules/gps.js?v=172',
    './js/fcm.js?v=172',
    './js/notifications.js?v=172',
    './js/pwa-install.js?v=172',
    './js/ui-settings.js?v=172',
    './js/modules/radar-v126.js?v=172',
    './js/gps-permissions.js?v=172',
    './js/app.js?v=172',
    './manifest.json?v=172',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=172',
    './assets/auto-conductor2.png?v=172'
];
