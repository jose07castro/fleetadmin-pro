...
const CACHE_NAME = 'fleetadmin-pro-v92';
const ASSETS = [
    './',
    './index.html?v=92',
    './css/index.css?v=92',
    ...
    './js/i18n.js?v=92',
    './js/firebase-config.js?v=92',
    './js/db.js?v=92',
    './js/units.js?v=92',
    './js/auth.js?v=92',
    './js/alerts.js?v=92',
    './js/components.js?v=92',
    './js/router.js?v=92',
    './js/storage.js?v=92',
    './js/modules/login.js?v=92',
    './js/modules/dashboard.js?v=92',
    './js/modules/shifts.js?v=92',
    './js/modules/maintenance.js?v=92',
    './js/modules/vehicles.js?v=92',
    './js/modules/settings.js?v=92',
    './js/modules/community.js?v=92',
    './js/modules/sos.js?v=92',
    './js/modules/announcements.js?v=92',
    './js/whatsapp.js?v=92',
    './js/modules/gps.js?v=92',
    './js/fcm.js?v=92',
    './js/notifications.js?v=92',
    './js/pwa-install.js?v=92',
    './js/app.js?v=92',
    './manifest.json?v=92',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=92')
