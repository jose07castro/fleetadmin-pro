...
const CACHE_NAME = 'fleetadmin-v79';
const ASSETS = [
    './',
    './index.html?v=79',
    './css/index.css?v=79',
    ...
    './js/router.js?v=79',
    './js/modules/login.js?v=79',
    './js/modules/dashboard.js?v=79',
    './js/modules/shifts.js?v=79',
    './js/modules/maintenance.js?v=79',
    './js/modules/vehicles.js?v=79',
    './js/modules/settings.js?v=79',
    './js/modules/community.js?v=79',
    './js/modules/sos.js?v=79',
    './js/modules/announcements.js?v=79',
    './js/whatsapp.js?v=79',
    './js/storage.js?v=79',
    './js/modules/gps.js?v=79',
    './js/fcm.js?v=79',
    './js/notifications.js?v=79',
    './js/pwa-install.js?v=79',
    './js/app.js?v=79',
    './manifest.json?v=79',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=79')
