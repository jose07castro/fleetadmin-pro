...
const CACHE_NAME = 'fleetadmin-v76';
const ASSETS = [
    './',
    './index.html?v=76',
    './css/index.css?v=76',
    ...
    './js/i18n.js?v=76',
    './js/firebase-config.js?v=76',
    './js/db.js?v=76',
    './js/units.js?v=76',
    './js/auth.js?v=76',
    './js/alerts.js?v=76',
    './js/components.js?v=76',
    './js/router.js?v=76',
    './js/modules/login.js?v=76',
    './js/modules/dashboard.js?v=76',
    './js/modules/shifts.js?v=76',
    './js/modules/maintenance.js?v=76',
    './js/modules/vehicles.js?v=76',
    './js/modules/settings.js?v=76',
    './js/modules/community.js?v=76',
    './js/modules/sos.js?v=76',
    './js/modules/announcements.js?v=76',
    './js/whatsapp.js?v=76',
    './js/storage.js?v=76',
    './js/modules/gps.js?v=76',
    './js/fcm.js?v=76',
    './js/notifications.js?v=76',
    './js/pwa-install.js?v=76',
    './js/app.js?v=76',
    './manifest.json?v=76',
    './assets/icon.svg',
    './assets/icon-192.png',
