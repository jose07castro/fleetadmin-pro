...
const CACHE_NAME = 'fleetadmin-v70';
const ASSETS = [
    './',
    './index.html?v=70',
    './css/index.css?v=70',
    ...
    './js/i18n.js?v=70',
    './js/firebase-config.js?v=70',
    './js/db.js?v=70',
    './js/units.js?v=70',
    './js/auth.js?v=70',
    './js/alerts.js?v=70',
    './js/components.js?v=70',
    './js/router.js?v=70',
    './js/modules/login.js?v=70',
    './js/modules/dashboard.js?v=70',
    './js/modules/shifts.js?v=70',
    './js/modules/maintenance.js?v=70',
    './js/modules/vehicles.js?v=70',
    './js/modules/settings.js?v=70',
    './js/modules/community.js?v=70',
    './js/modules/sos.js?v=70',
    './js/modules/announcements.js?v=70',
    './js/whatsapp.js?v=70',
    './js/storage.js?v=70',
    './js/modules/gps.js?v=70',
    './js/fcm.js?v=70',
    './js/notifications.js?v=70',
    './js/pwa-install.js?v=70',
    './js/app.js?v=70',
    './manifest.json?v=70',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=70')
