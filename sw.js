...
const CACHE_NAME = 'fleetadmin-pro-v88';
const ASSETS = [
    './',
    './index.html?v=88',
    './css/index.css?v=88',
    ...
    './js/i18n.js?v=88',
    './js/firebase-config.js?v=88',
    './js/db.js?v=88',
    './js/units.js?v=88',
    './js/auth.js?v=88',
    './js/alerts.js?v=88',
    './js/components.js?v=88',
    './js/router.js?v=88',
    './js/modules/login.js?v=88',
    './js/modules/dashboard.js?v=88',
    './js/modules/shifts.js?v=88',
    './js/modules/maintenance.js?v=88',
    './js/modules/vehicles.js?v=88',
    './js/modules/settings.js?v=88',
    './js/modules/community.js?v=88',
    './js/modules/sos.js?v=88',
    './js/modules/announcements.js?v=88',
    './js/whatsapp.js?v=88',
    './js/storage.js?v=88',
    './js/modules/gps.js?v=88',
    './js/fcm.js?v=88',
    './js/notifications.js?v=88',
    './js/pwa-install.js?v=88',
    './js/app.js?v=88',
    './manifest.json?v=88',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=88')
