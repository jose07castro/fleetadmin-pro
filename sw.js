...
const CACHE_NAME = 'fleetadmin-pro-v178';
const ASSETS = [
    './',
    './index.html?v=178',
    './css/index.css?v=178',
    ...
    './js/auth.js?v=178',
    './js/alerts.js?v=178',
    './js/components.js?v=178',
    './js/router.js?v=178',
    './js/storage.js?v=178',
    './js/modules/login.js?v=178',
    './js/modules/dashboard.js?v=178',
    './js/modules/shifts.js?v=178',
    './js/modules/maintenance.js?v=178',
    './js/modules/vehicles.js?v=178',
    './js/modules/settings.js?v=178',
    './js/modules/community.js?v=178',
    './js/modules/sos.js?v=178',
    './js/modules/announcements.js?v=178',
    './js/whatsapp.js?v=178',
    './js/modules/gps.js?v=178',
    './js/fcm.js?v=178',
    './js/notifications.js?v=178',
    './js/pwa-install.js?v=178',
    './js/ui-settings.js?v=178',
    './js/modules/radar-v126.js?v=178',
    './js/gps-permissions.js?v=178',
    './js/app.js?v=178',
    './manifest.json?v=178',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    './assets/admin.png?v=178',
    './assets/auto-conductor2.png?v=178'
];
