...
const CACHE_NAME = 'fleetadmin-pro-v86';
const ASSETS = [
    './',
    './index.html?v=86',
    './css/index.css?v=86',
    ...
    './js/i18n.js?v=86',
    './js/firebase-config.js?v=86',
    './js/db.js?v=86',
    './js/units.js?v=86',
    './js/auth.js?v=86',
    './js/alerts.js?v=86',
    './js/components.js?v=86',
    './js/router.js?v=86',
    './js/modules/login.js?v=86',
    './js/modules/dashboard.js?v=86',
    './js/modules/shifts.js?v=86',
    './js/modules/maintenance.js?v=86',
    './js/modules/vehicles.js?v=86',
    './js/modules/settings.js?v=86',
    './js/modules/community.js?v=86',
    './js/modules/sos.js?v=86',
    './js/modules/announcements.js?v=86',
    './js/whatsapp.js?v=86',
    './js/storage.js?v=86',
    './js/modules/gps.js?v=86',
    './js/fcm.js?v=86',
    './js/notifications.js?v=86',
    './js/pwa-install.js?v=86',
    './js/app.js?v=86',
    './manifest.json?v=86',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=86')
