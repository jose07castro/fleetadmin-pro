...
const CACHE_NAME = 'fleetadmin-v68';
const ASSETS = [
    './',
    './index.html?v=68',
    './css/index.css?v=68',
    ...
    './js/i18n.js?v=68',
    './js/firebase-config.js?v=68',
    './js/db.js?v=68',
    './js/units.js?v=68',
    './js/auth.js?v=68',
    './js/alerts.js?v=68',
    './js/components.js?v=68',
    './js/router.js?v=68',
    './js/modules/login.js?v=68',
    './js/modules/dashboard.js?v=68',
    './js/modules/shifts.js?v=68',
    './js/modules/maintenance.js?v=68',
    './js/modules/vehicles.js?v=68',
    './js/modules/settings.js?v=68',
    './js/modules/community.js?v=68',
    './js/modules/sos.js?v=68',
    './js/modules/announcements.js?v=68',
    './js/whatsapp.js?v=68',
    './js/storage.js?v=68',
    './js/modules/gps.js?v=68',
    './js/fcm.js?v=68',
    './js/notifications.js?v=68',
    './js/pwa-install.js?v=68',
    './js/app.js?v=68',
    './manifest.json?v=68',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=68')
