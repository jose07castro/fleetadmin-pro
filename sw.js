...
const CACHE_NAME = 'fleetadmin-pro-v90';
const ASSETS = [
    './',
    './index.html?v=90',
    './css/index.css?v=90',
    ...
    './js/i18n.js?v=90',
    './js/firebase-config.js?v=90',
    './js/db.js?v=90',
    './js/units.js?v=90',
    './js/auth.js?v=90',
    './js/alerts.js?v=90',
    './js/components.js?v=90',
    './js/router.js?v=90',
    './js/storage.js?v=90',
    './js/modules/login.js?v=90',
    './js/modules/dashboard.js?v=90',
    './js/modules/shifts.js?v=90',
    './js/modules/maintenance.js?v=90',
    './js/modules/vehicles.js?v=90',
    './js/modules/settings.js?v=90',
    './js/modules/community.js?v=90',
    './js/modules/sos.js?v=90',
    './js/modules/announcements.js?v=90',
    './js/whatsapp.js?v=90',
    './js/modules/gps.js?v=90',
    './js/fcm.js?v=90',
    './js/notifications.js?v=90',
    './js/pwa-install.js?v=90',
    './js/app.js?v=90',
    './manifest.json?v=90',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=90')
