...
const CACHE_NAME = 'fleetadmin-pro-v117';
const ASSETS = [
    './',
    './index.html?v=117',
    './css/index.css?v=117',
    ...
    './js/i18n.js?v=117',
    './js/firebase-config.js?v=117',
    './js/db.js?v=117',
    './js/units.js?v=117',
    './js/auth.js?v=117',
    './js/alerts.js?v=117',
    './js/components.js?v=117',
    './js/router.js?v=117',
    './js/storage.js?v=117',
    './js/modules/login.js?v=117',
    './js/modules/dashboard.js?v=117',
    './js/modules/shifts.js?v=117',
    './js/modules/maintenance.js?v=117',
    './js/modules/vehicles.js?v=117',
    './js/modules/settings.js?v=117',
    './js/modules/community.js?v=117',
    './js/modules/sos.js?v=117',
    './js/modules/announcements.js?v=117',
    './js/whatsapp.js?v=117',
    './js/modules/gps.js?v=117',
    './js/fcm.js?v=117',
    './js/notifications.js?v=117',
    './js/pwa-install.js?v=117',
    './js/ui-settings.js?v=117',
    './js/modules/radar.js?v=117',
    './js/gps-permissions.js?v=117',
    './js/app.js?v=117',
    './manifest.json?v=117',
    './assets/icon.svg',
    './assets/icon-192.png',
    ...
    event.respondWith(
        caches.match(event.request).then(cached => {
            ...
            if (event.request.destination === 'document' || event.request.mode === 'navigate') {
                return caches.match('./index.html?v=117')
